...
public class MainObj {
     ...
     public static void main(String[] args) {
        ...
        Object[] arraySumaAB = 
                OperarArraysObject.OperarArrayObjects(array_A, array_B, MainObj::suma);
        ...
        Object[] arrayDivideAB = 
                OperarArraysObject.OperarArrayObjects(array_A, array_B, divide);
        arrayEnTabla(System.out, arrayDivideAB);
        
        Object[] arrayPuntosAB = 
                OperarArraysObject.OperarArrayObjects(array_A, array_B, MainObj::hacerPunto);
