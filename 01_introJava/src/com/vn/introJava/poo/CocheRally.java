...
/** Clase Coche Rally para controlar otras caracteristicas
...
public class CocheRally extends Coche {
     ...
     * Al implementar un constructor, el de por defecto deja de ser 
     * implementado por Java
     * 
     * @param marca 
     */
  ...
  return arrancado;
    ...
    public void mostrarEstado() {
         System.out.println("Soy un Coche de rally" + getMarca()  + ", rozamiento = " + rozamiento +
