...
public class TestServicioUsuarios {
    ...
    public void crearUsuariosValidos() {
        Usuario u1 = srvUsu.crear("arrrr@a.a", "1234", "Nom A", "20");
        Usuario u2 = srvUsu.crear("a@a.a2", "1234", "Nom B", "30");
        Usuario u3 = srvUsu.crear("a@ee.a2", "e1234", "Nom C", "40");
        
        assertTrue(srvUsu.leerUno("arrrr@a.a").getId() > 0);
    ...
    public void modificarUsuariosValidos() {
        ...
        assertEquals(25, srvUsu.leerUno("arrrr@a.a").getEdad());
    ...
    public void eliminarUsuarios() {
        ...
        assertNull(srvUsu.leerUno("arrrr@a.a"));
    ...
    public void listarTodos() {
        ...
        listaCreados.add(srvUsu.crear("arrrr@a.a", "1234", "Nom A", "20"));
        ...
        for (Usuario usuario1 : listaCreados) {
            if (usuario1 != null && listaTodos.contains(usuario1)) {
                srvUsu.eliminar(usuario1.getId());
            } else {
                fail ("No se ha añadido o no se ha encontrado en listaTodos");
            }
